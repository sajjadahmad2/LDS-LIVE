...
return new class extends Migration
{
    ...
    {
        Schema::create('proccess_contacts', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('status', ['In Compelete', 'Compelete'])->default('In Compelete');
    ...
    {
        Schema::dropIfExists('proccess_contacts');
    }
};
