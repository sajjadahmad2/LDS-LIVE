...
use Carbon\Carbon;
class ReserveContactServices{
    public function handleReserveContact(array $data,$agent=null,$campaign){
        ...
        //dd($my_signature);
        $reserveContact = ReserveContact::where('contact_id', $contact_id)->first();
          $contactData = [
